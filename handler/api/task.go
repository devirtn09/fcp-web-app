...
func (t *taskAPI) UpdateTask(c *gin.Context) { // TODO: answer here
	var newTask model.Task
	if err := c.ShouldBindJSON(&newTask); err != nil {
		c.JSON(http.StatusBadRequest, model.ErrorResponse{Error: err.Error()})
		return
...
func (t *taskAPI) DeleteTask(c *gin.Context) { // TODO: answer here
	taskID, err := strconv.Atoi(c.Param("id"))
	if err != nil {
		c.JSON(http.StatusBadRequest, model.ErrorResponse{Error: "Invalid task ID"})
		return
...
func (t *taskAPI) GetTaskList(c *gin.Context) { // TODO: answer here
...
func (t *taskAPI) GetTaskListByCategory(c *gin.Context) { // TODO: answer here
	taskID, err := strconv.Atoi(c.Param("id"))
	if err != nil {
		c.JSON(http.StatusBadRequest, model.ErrorResponse{Error: "Invalid task ID"})
		return
