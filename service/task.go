...
func (s *taskService) Update(id int, task *model.Task) error { // TODO: replace this
	return s.taskRepository.Update(id, task)
}

func (s *taskService) Delete(id int) error { // TODO: replace this
...
func (s *taskService) GetList() ([]model.Task, error) { // TODO: replace this
	return s.taskRepository.GetList()
}

func (s *taskService) GetTaskCategory(id int) ([]model.TaskCategory, error) { // TODO: replace this
